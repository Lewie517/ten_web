        ...
        <div class="account-person">
          ...
          <ul class="account-info">
            <li>
              ...
              <form v-show="name_input">
                ...
                <button
                  type="button"
                  class="sui-btn btn-danger save-btn"
                  @click="name_input=false"
                >取消</button>
              </form>
              <span class="gray edit">
                <a class="fa fa-pencil" aria-hidden="true" @click="name_input=true">编辑</a>
              </span>
            </li>
            ...
            <li>
              ...
              <span class="gray edit">
                <a class="fa fa-pencil" @click="test" aria-hidden="true">编辑</a>
              </span>
            </li>
            <li>
              ...
              <span class="gray edit">
                <a class="fa fa-pencil" aria-hidden="true">编辑</a>
              </span>
            </li>
            <li>
          ...
          <ul class="account-info">
            <li>
              <span class="gray index">
                <img src="~/assets/img/widget-weixin.png" width="20"> 微信
              </span>
              <span class="name">已绑定，解绑</span>
              <span class="gray check">
                <i class="fa fa-square-o" aria-hidden="true"></i> 公开显示
              </span>
            </li>
            <li>
              <span class="gray index">
                <img src="~/assets/img/widget-QQ.png" width="20"> QQ
              </span>
